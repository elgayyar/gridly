...
var consumerProfile = module.exports = mongoose.model('consumerProfile', consumerProfileSchema);
...
function add(object){
    return new Promise (function (resolve, reject) {
        var document = new consumerProfile(object);
        if (!document.fName){
...
function deleteOne(id){
    return new Promise (function (resolve, reject) {
        consumerProfile.findById(id, function (error, document) {
            if (error){
                reject(error);
            }else{
...
function getAll(){
    return new Promise (function (resolve, reject) {
        consumerProfile.find({}, function (error, documents) {
            if (error){
                reject(error);
            }else{
                resolve(documents);
